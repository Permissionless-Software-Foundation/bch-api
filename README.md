...
There are two installation paths, depending if you want a _development_ or
_production_ environment. You'll also need to set up the underlying infrastructure
