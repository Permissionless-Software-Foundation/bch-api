...
class PsfSlpIndexer {
  constructor () {
    ...
    this.getMutableCid = this.getMutableCid.bind(this)
  }
  ...
  async getTokenData (req, res, next) {
    try {
      ...
      try {
        ...
        const mutableData = await _this.getMutableCid(tokenStats)
  ...
  // CT 10/30/25: This function may be deprecated? It was being used by
  // getTokenData() to get the mutable data, but this function was
  // replaced by getMutableCid().
  ...
  // CT 10/30/25: This function replaced getMutableData().
