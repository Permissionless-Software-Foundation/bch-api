...
async function balancesForAddressByTokenID (req, res, next) {
  try {
    ...
    const slpAddr = bchjs.SLP.Address.toSlpAddress(req.params.address)
...
async function convertAddressSingle (req, res, next) {
  try {
    ...
    const slpAddr = bchjs.SLP.Address.toSLPAddress(address)
    ...
    obj.cashAddress = bchjs.SLP.Address.toCashAddress(slpAddr)
    obj.legacyAddress = bchjs.SLP.Address.toLegacyAddress(obj.cashAddress)
